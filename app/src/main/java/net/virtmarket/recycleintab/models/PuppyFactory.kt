...
/**
 * Created by Olersandr.
 */

class PuppyFactory(private val context: Context) {

    val puppies: ArrayList<User>
        get() {
            val result = ArrayList<User>()
            //result.add(User("id01","Harper", getDescription(0), getDrawableByName("puppy1"), false, false, false))
            result.add(User("id01","Harper", "test1@gmail.com", getDrawableByName("puppy1"), false, false, false))
            result.add(User("id02","Lucy", "test1@gmail.com", getDrawableByName("puppy2"), false, true, false))
            result.add(User("id03","Adrian", "test1@gmail.com", getDrawableByName("puppy3"), false, true, false))
            result.add(User("id04","Bella", "test1@gmail.com", getDrawableByName("puppy4"), true, false, true))
            result.add(User("id05","Tildy", "test1@gmail.com", getDrawableByName("puppy5"), true, false, false))
            result.add(User("id06","Apollo", "test1@gmail.com", getDrawableByName("puppy6"), true, true, false))
            result.add(User("id07","Roxie", "test1@gmail.com", getDrawableByName("puppy7"), false, false, false))
            result.add(User("id08","Junior", "test1@gmail.com", getDrawableByName("puppy8"), true, false, true))
            result.add(User("id09","Dede", "test1@gmail.com", getDrawableByName("puppy9"), false, true, false))
            return result
        }

    val activePuppies: ArrayList<User>
        get() {
            val allPuppies = puppies
            val selectedPuppies = ArrayList<User>()
    ...
    val smallPuppies: ArrayList<User>
        get() {
            val allPuppies = puppies
            val selectedPuppies = ArrayList<User>()
            for (puppy in allPuppies) {
    ...
    val leashTrainedPuppies: ArrayList<User>
        get() {
            val allPuppies = puppies
            val selectedPuppies = ArrayList<User>()
            for (puppy in allPuppies) {
